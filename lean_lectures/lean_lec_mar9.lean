...
Scratchpad / lecture file for Mar 9.
-/

/-
## 1. Coxeter groups in Lean (Ming Lim)
...
Patrick presented on the Stone representation theorem (If B is a Boolean algebra, there is a set X such that B embeds into the power set of X).
